...
function load_scripts(){
	...
	wp_enqueue_script('jquery', 'https://code.jquery.com/jquery-3.6.0.js', array(), '3.6.0', false);
	...
	wp_enqueue_script('template', get_template_directory_uri(). '/js/style.js', array('jquery'), '1.0', false);
...
add_action( 'after_setup_theme' , 'vibe_config' , 0 );